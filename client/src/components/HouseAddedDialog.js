...
function HouseAddedDialog({ open, handleClose, id }) {
    ...
    return (
        <Root onClose={handleClose} open={open} PaperProps={{ style: styles.dialogPaper }}>
            <Lottie animationData={SuccessAnimation} loop={false} style={styles.successAnimation} />
            ...
            <ActionsContainer>
                <ViewHouseButton onClick={() => navigate('/view-house?id=' + id)}>View house</ViewHouseButton>
                <AddAnotherHouseButton onClick={handleClose}>Add another house</AddAnotherHouseButton>
            </ActionsContainer>
        </Root>
    );
}
